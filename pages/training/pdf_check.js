      ...
      <PDFExport ref={pdfExportComponent} paperSize="A4">
        ...
        >
          ...
          <div className="flex flex-col items-center  right-0 h-full bg-white w-6/7">
            <div className="flex pt-2 space-x-3">
              ...
              <div className="flex flex-col items-start text-sm">
                <div className="font-sans ">
                  <Image src="/udyogasha.png" height={60} width={180}></Image>
                </div>
              </div>
            </div>
            ...
            <div className="text-xxs">MIIRD CR Act 1957 Govt. of India.</div>
            <div className="text-xxs">
              Board for Implementation of Vocational Training Schemes Govt. of
              Maharashtra
            </div>
            ...
            <div className="text-xxs font-medium">
              (National Skill Development Corporation Training Partner Reg. No.
              055402)
            </div>
