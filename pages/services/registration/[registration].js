...
const Registation = () => {
  ...
  return (
    <div className="h-full min-h-screen w-full pt-14 bg-registration  bg-cover ">
      <div className="min-h-screen w-full px-10 relative bg-yellow-200 bg-opacity-80">
        {loading == true && (
              ...
              <div key={data.name} className="">
                <div className="flex flex-col justify-between bg-yellow-600 rounded-lg h-72  shadow-md">
                  ...
                  <button
                    ...
                    className="bg-yellow-100 text-gray-800 bg-opacity-60 shadow-xl py-4 rounded-b-lg"
                  >
                    Apply Now
                  </button>
                </div>
