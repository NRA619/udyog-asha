...
export default function Admin_training() {
  ...
  return (
    <div className="min-h-screen py-20 w-full">
      <div className="flex justify-center items-center px-0 md:px-20">
        <div className="bg-gray-800 h-full min-h-screen w-full">
          <div className="flex flex-col w-full">
            ...
            {form2 == false && (
              ...
              <span className="text-white text-3xl font-sans font-normal underline ">
                Begin with adding chapters
              </span>
            </div>
                <div className="grid lg:grid-cols-2 grid-cols-1 justify-items-center place-items-center  gap-y-20">
                  <div className="flex  space-x-10 w-96">
                ...
                <div className="flex space-x-10 pt-10 justify-center">
                  ...
                  <input
                    ...
                    className="shadow-md bg-gray-900 focus:ring-1 focus:ring-yellow-400 text-whitel border-0 focus:outline-none h-9 w-60"
                  ></input>
                ...
                <div className="flex justify-center pt-10">
                  <button onClick={() => setform2(true)} className="py-2 px-5 bg-gray-900 shadow-md rounded-md text-white">Finish</button>
                </div>
              </div>
            )}
            {form2 == true && (
              <div className="w-full h-full">
                <div className="flex justify-center pt-10">
                  <span className="text-white text-3xl font-sans font-normal underline">Now it is time for add Course</span>
                </div>
              <form
              ...
              >
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <select
                    ...
                    className="shadow-md bg-gray-900 focus:ring-1 focus:ring-yellow-400 text-white border-0 focus:outline-none h-10 w-80"
                  >
                    <option value="Food and Food Product" className="w-96">
