                ...
                <div className="flex justify-between items-center w-full text-white space-x-14 p-4">
                  <span className="flex space-y-4 flex-col">
                    ...
                    <Image
                      ...
                      className=""
                    ></Image>
                    <span className="text-xs justify-center">साले धनकवड</span>
                    <span className="text-xs">धनकवडी, पुणे.</span>
                  </span>
              ...
              <div className="mx-2 bg-gray-900 rounded-md shadow-sm y p-2 ">
                <div className="flex justify-between items-center w-full text-white space-x-14 p-4">
                  <span className="flex space-y-4 flex-col">
                    ...
                    <span className="text-xs">अभ्यंकर्स मनोभावना फुड्स</span>
                    <span className="text-xs">नवी पेठ, पुणे.</span>
                  </span>
                  <span className="text-center">
              ...
              <div className="mx-2 bg-gray-900 rounded-md shadow-sm y p-2 ">
                <div className="flex justify-between items-center w-full text-white space-x-14 p-4">
                  <span className="flex space-y-4 flex-col w-1/2">
                    ...
                    <span className="text-xs">Soapy oaks</span>
                    <span className="text-xs">Palgad, Dapoli</span>
                    <span className="text-xs">Small scale industries</span>
                  </span>
                  <span className="text-center">
