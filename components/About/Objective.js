     ...
     <main className = "h-full w-full bg-blackbg bg-cover"> 
      <div className=" flex flex-col justify-around md:grid md:grid-cols-2 md:justify-items-center items-center  md:h-1/2  text-white">
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/7L0NhKqX/IMG-20181026-135911655-HDR.jpg"
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/6pH0F8YL/IMG-20171229-151135.jpg"
              className="filter saturate-150 shadow-xl"
              width={1300}
              height={800}
              layout="responsive"
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/bN9LHCn5/IMG-20180121-123028.jpg"
              className="filter saturate-150 shadow-xl"
              width={1300}
              height={800}
              layout="responsive"
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/j2pVH8J2/IMG-20180325-164644349.jpg"
              className="filter saturate-150 shadow-xl"
              width={1300}
              height={800}
              layout="responsive"
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/k5BcC7Hr/IMG-20171229-165709.jpg"
              className="filter saturate-150 shadow-xl"
              width={1300}
              height={800}
              layout="responsive"
         ...
         <div className="md:w-3/4 my-10 glow-blue-900-2xl">   
            <Image
              src="https://i.postimg.cc/Njy9fLQx/IMG-20180425-124309640.jpg"
              className="filter saturate-150 shadow-xl"
              width={1300}
              height={800}
              layout="responsive"
         ...
         <span className="w-4/5  md:hidden">
         ...
         <span className="w-5/6 pb-10 text-justify md:mr-5 md:hidden pt-10">
